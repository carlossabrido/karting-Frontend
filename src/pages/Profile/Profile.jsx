...
export const Profile = () => {
  ...
  const editProfile = async (profileId) => {
    ...
    if (
      ...
      modifyProfilee(dataRx.credentials, profileId, modifyProfile).then(
        (resultado) => setModifyProfile(resultado)
      );
      updateProfile();
          ...
          <div className="desingButton">
            ...
            <Modal show={show} onHide={handleClose}>
              ...
              <Modal.Footer>
                ...
                <Button
                  variant="primary"
                  onClick={() => editProfile(infoProfile._id)}
                >
                  Save Changes
                </Button>
                {showError && (
                  <div className="error-message">Fill up all the fields</div>
                )}
              </Modal.Footer>
            </Modal>
          </div>
